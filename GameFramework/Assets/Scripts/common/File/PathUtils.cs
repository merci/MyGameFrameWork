...
using System;
    ...
    public class PathUtils
    {
        ...
        /// <returns></returns>
        public static string GetSpecialPath(string assetPath, ResLoadPath type)
        {
            string path = assetPath;

            switch (type)
            {
                case ResLoadPath.Resources:
                    path = Application.dataPath + "/Resources/" + path;
                    break;
                case ResLoadPath.Persistent:
                    path = Application.persistentDataPath + "/" + path;
                    break;
                case ResLoadPath.StreamingAssets:
